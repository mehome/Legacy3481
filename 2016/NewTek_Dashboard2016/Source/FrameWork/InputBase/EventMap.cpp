...
FrameWork::FrameLogger::FrameLogger(string logFileName) : m_logFileName(logFileName), m_active(false), m_currRecordedTimeSet(NULL)
{
}
//////////////////////////////////////////////////////////////////////////

void FrameWork::FrameLogger::ListenForToggleEvent(Event0& ev)
{
	ev.Subscribe(ehl, *this, &FrameWork::FrameLogger::ToggleActive);
}
//////////////////////////////////////////////////////////////////////////

void FrameWork::FrameLogger::ListenForTimerUpdate(Event1<double>& timerEv)
{
	timerEv.Subscribe(ehl, *this, &FrameWork::FrameLogger::TimeChanged);
}
//////////////////////////////////////////////////////////////////////////

FrameWork::FrameLogger::~FrameLogger()
{
	// Does nothing if already written
	WriteLog();
}

void FrameWork::FrameLogger::WriteLog()
{
...
void FrameWork::FrameLogger::TimeChanged(double t)
{
...
void FrameWork::ValueLogger::SetLogger(FrameLogger& fl)
{
	fl.TimerEvent.Subscribe(ehl, *this, &FrameWork::ValueLogger::TimerEvent);
	fl.WriteTitles.Subscribe(ehl, *this, &FrameWork::ValueLogger::WriteTitles);
	fl.WriteValues.Subscribe(ehl, *this, &FrameWork::ValueLogger::WriteValues);
}
//////////////////////////////////////////////////////////////////////////

void FrameWork::ValueLogger::WriteTitles(FILE* logFile)
{
	// Write our name to the log file
	fprintf(logFile,",%s", m_itemName.c_str());
}

void FrameWork::ValueLogger::TimerEvent(double lastTime, double currTime)
{
	// Remember our current value
	m_valSet.push_back(V);
}
void FrameWork::ValueLogger::WriteValues(FILE* logFile, double lastTime, double currTime)
{
...
FrameWork::ProfilingLogger::ProfilingLogger(string itemName) : 
	FrameWork::ValueLogger(itemName), begC(0), endC(0)
{
	assert(false);  
...
void FrameWork::ProfilingLogger::Start()
{
	assert(false);  
	//QueryPerformanceCounter((LARGE_INTEGER *)&begC);
}
void FrameWork::ProfilingLogger::End()
{
	assert(false);
...
FrameWork::Timer::Timer(string logFileName) : Logger(logFileName),_currentTime_s(0.0) 
{
...
double FrameWork::Timer::SetCurrTime_s(double t)
{
...
double FrameWork::Timer::IncTime_s(double i_s)
{
	if (i_s)
	{
		_currentTime_s += i_s;
