...
extern const _MM_ALIGN16 float __1000_[4];
extern const _MM_ALIGN16 __int32 __0FFF_[4];
extern const _MM_ALIGN16 float __ZERONE_[4];
...
inline void MatrixMult(const SPMatrix& A, const SPMatrix& B, SPMatrix& res) {
...
#else
	F32vec4 B1=_mm_loadu_ps((float *)&B._L1);
	F32vec4 B2=_mm_loadu_ps((float *)&B._L2);
	F32vec4 B3=_mm_loadu_ps((float *)&B._L3);
	F32vec4 B4=_mm_loadu_ps((float *)&B._L4);
#endif
    ...
    res._L2 = r2;
#else
	_mm_storeu_ps((float *)&res._L1,r1);
	_mm_storeu_ps((float *)&res._L2,r2);
#endif
    ...
    res._L4 = r2;
#else
	_mm_storeu_ps((float *)&res._L3,r1);
	_mm_storeu_ps((float *)&res._L4,r2);
#endif
}
