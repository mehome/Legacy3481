...
int VisionStrongholdGoalTracker::ProcessImage(double &x_target, double &y_target)
{
	...
	particleListVert.SetParticleParams( 0.31666667f, (12.0f/12), (20.0f/12) );	// area threshold, aspect min, max
...
int VisionStrongholdGoalTracker::hotOrNot(TargetReport target)
{
	bool isHot = true;
