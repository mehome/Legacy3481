...
public:
		...
		double LeftDrivePassthrough(double);//!< Sets the left side of the drive train to a value <=1 not controlled by a controller.
		double RightDrivePassthrough(double);//!< Sets the right side of the drive train to a value <=1 not controlled by a controller.
...
private:
		...
		vector<Victor*> leftDriveVictors;//!< Pointers to the left side victors stored in the config.
		vector<Victor*> rightDriveVictors;//!< Pointers to the right side victors stored in the config.
		Victor *kickerWheel;//!< Pointer to the kicker wheel victor stored in the config.
