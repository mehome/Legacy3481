...
#ifdef CRIO
void InitializePneumatics(){ SystemsCollection::Instance().pneumatics.Initialize(); }//!< Indirectly creates an instance of the pneumatics and calls it's Initialize function.
#endif
