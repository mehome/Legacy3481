...
MainRobot = {
	Mass = 25, -- Weight kg
	MaxAccelLeft = 3, MaxAccelRight = 3, MaxAccelForward = 3, MaxAccelReverse = 3, 
	MaxTorqueYaw = 25, 
	...
	robot_settings =
	{
		...
		fire_trigger_delay=0.130,			--Used to wait for a stable rate before engaging the conveyor
		...
		grid_corrections =
		{
			...
			c21={p=2.4, x=1.0}, c22={p=1.8, x=1.0}, c23={p=2.4, x=1.0},  --MATTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT change P
		...
		power =
		{
			...
			tolerance=50.0,					--we need decent precision (this will depend on ramp up time too)
			...
			min_range=19 * Pi2				--We borrow the min range to represent the min speed (was 17 as of 3:20 PM 4/21, changed for calibrations)
