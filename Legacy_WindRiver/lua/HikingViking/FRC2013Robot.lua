...
HighGearSpeed = (372.63 / 60.0) * Pi * g_wheel_diameter_in * Inches2Meters  --RPM's from Parker
...
MainRobot = {
	...
	tank_drive =
	{
		...
		{p=150, i=0, d=25},
		right_pid=
		{p=150, i=0, d=25},					--These should always match, but able to be made different
		tolerance=0.2,
		heading_latency=0.06,
	...
	robot_settings =
	{
		...
		climb_gear_lift = 
		{
			...
			tank_drive =
			{
				...
				inv_max_accel_left = 1.0/18.0,
				inv_max_accel_right = 1.0/8.0,
			}
		},
		...
		climb_gear_drop = 
		{
			tank_drive =
			{
				...
				inv_max_accel_left = 1.0/10.0,
				inv_max_accel_right = 1.0/22.0,
				inv_max_decel_left = 1.0/13.0,
				inv_max_decel_right = 1.0/7.0
			}
		}
	},
