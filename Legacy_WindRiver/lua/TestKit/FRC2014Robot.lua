...
MainRobot = {
	...
	control_assignments =
	{
		...
		victor =
		{
			id_1 = { name= "left_drive_1", channel=8, module=1}, 
			id_2 = { name= "left_drive_2", channel=9}, 
			...
			id_7 = { name="winch",         channel=1}, 
			id_8 = { name="intake_arm_1",  channel=2},
			id_9 = { name="intake_arm_2",  channel=7},
