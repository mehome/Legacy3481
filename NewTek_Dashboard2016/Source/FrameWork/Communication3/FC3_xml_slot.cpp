...
{	// Get the slot
	...
	FC3::xml::message* p_msg = p_slot->get< FC3::xml::message >( slot_no );
...
{	// Get the slot
	...
	// Get the message
	FC3::xml::message* p_msg_ret = p_slot->replace< FC3::xml::message >( slot_no, p_msg );
...
{	// Get the slot
	...
	return p_slot->put< FC3::xml::message >( slot_no, p_msg );
}