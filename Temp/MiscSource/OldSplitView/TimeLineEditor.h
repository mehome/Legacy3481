#ifndef __TIMELINEEDITOR__
#define __TIMELINEEDITOR__

#define TimeLine_Editor_SkinRoot		"VideoEditor/TimeLine"

class InOuts2_Control;

class VIDEOEDITORDLL TimeLine_Editor :	public VideoEditorClient_Interface,public BaseLoadSave_UiConfig {
	public:
