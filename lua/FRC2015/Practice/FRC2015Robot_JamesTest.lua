...
MainRobot = {
	...
	control_assignments =
	{
		...
		victor =
		{
			...
			id_4 = { name="left_drive_2", channel=6},
			id_5= { name="kicker_wheel", channel=5},
			id_6= { name="arm", channel=4}
		...
		analog_input =
		{
			id_1 = { name="arm_potentiometer",  channel=1},
		},
	...
	robot_settings =
	{
		...
		arm =
		{
			...
			brake=1.0,
			max_accel_forward=1.05,			--These are in radians, just go with what feels right
			max_accel_reverse=1.05,
	...
	--	slotlist = {slot_1="controller (xbox 360 for windows)", slot_2="gamepad f310 (controller)", slot_3="logitech dual action"},
		...
		--	KickerWheel_SetCurrentVelocity = {type="joystick_analog", key=0, is_flipped=false, multiplier=1.0, filter=0.5, curve_intensity=1.0},
			KickerWheel_SetCurrentVelocity = {type="joystick_dual_analog", key_1=2, key_2=3, is_flipped=false, multiplier=1.0, filter=0.5, curve_intensity=1.0},
		...
		Joystick_2 =
		{
			...
			Arm_SetTote2Height = {type="joystick_button", key='1', on_off=false},
			Arm_SetTote3Height = {type="joystick_button", key='2', on_off=false},
