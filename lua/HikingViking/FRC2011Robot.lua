...
TestShip = {
	...
	MAX_SPEED = GearSpeed * 1.04, -- Maximum Speed (m/s) use to be 2.916 but computed to 2.974848
	...
	tank_drive =
	{
		...
		{p=150, i=0, d=50},
		right_pid=
		{p=150, i=0, d=50},					--These should always match, but able to be made different
		latency=0.0,
		heading_latency=0.6,
		drive_to_scale=0.80,
