...
HighGearSpeed = (427.68 / 60.0) * Pi * FRC2012_wheel_diameter_in * Inches2Meters  --RPM's from Parker  (This is 3.4127347)
LowGearSpeed  = (167.06 / 60.0) * Pi * FRC2012_wheel_diameter_in * Inches2Meters

KeyDistance_in=144;
--KeyDistance_in=0;  --Make auton go farther
KeyWidth_in=101;
KeyDepth_in=48;
...
MainRobot = {
	...
	tank_drive =
	{
		...
		left_pid=
		{p=200, i=0, d=50},					--In FRC 2011 pid was 1,1,0 but lets keep i to zero if we can
		right_pid=
	...
	robot_settings =
	{
		...
		controls =
		{
			Joystick_1 =
			{
				...
				--Turret_SetIntendedPosition = {type="joystick_analog", key=2, is_flipped=false, multiplier=1.0, filter=0.0, is_squared=false},
