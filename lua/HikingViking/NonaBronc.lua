...
WheelBase_Width_In=22.3125	  --These determine the turn rate, must be as accurate as possible!
WheelBase_Length_In=22.3125
WheelTurningDiameter_In= ( (WheelBase_Width_In * WheelBase_Width_In) + (WheelBase_Length_In * WheelBase_Length_In) ) ^ 0.5
HighGearSpeed = (372.63 / 60.0) * Pi * wheel_diameter_in * Inches2Meters  --RPM's from Parker
