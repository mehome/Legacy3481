...
MainRobot = {
	...
	controls =
	{
		...
		Joystick_1 =
		{
			...
			FieldCentric_EnableValue = {type="joystick_analog", key=0, is_flipped=true, multiplier=1.0, filter=0.1, curve_intensity=0.0},
